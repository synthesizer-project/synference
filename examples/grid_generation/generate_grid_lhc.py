...
sfh_timescale_popIII = (
    0.01,
    30,
)  # Length of Time - e.g. min_age_popIII + popIII_sfh_timescale
...
# SFH
sfh_array = np.vstack(
    (all_param_dict["min_age_popIII"], all_param_dict["sfh_timescale_popIII"])
).T
...
combined_basis.create_grid(
    overwrite=True,
    overload_out_name="BPASS_Chab+yggdrasil_fcov_1_salpeter_10,1,500_combined",
)
